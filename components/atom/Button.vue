<template>
    <button
        class="rounded-md border border-transparent py-2 px-4 text-sm font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2"
        :class="{
            'bg-slate-300 text-slate-500 border-slate-200 shadow-none hover:bg-slate-400':
                disabled || loading,
