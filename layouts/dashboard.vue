    ...
    <div class="flex flex-1 flex-col overflow-hidden">
      ...
      <div class="flex flex-1 items-stretch overflow-hidden">
        <main class="flex-1 overflow-y-auto">
          <!-- Primary column -->
          <section aria-labelledby="primary-heading" class="flex h-full min-w-0 flex-1 flex-col lg:order-last p-6">
            <slot />
          </section>
        </main>
...
const sidebarNavigation = [
  ...
  { name: 'My Pets', href: '#', icon: HomeIcon, current: false },
  { name: 'Matches', href: '#', icon: PhotoIcon, current: true },
  { name: 'Messages', href: '#', icon: UserGroupIcon, current: false },
  { name: 'Posters', href: '#', icon: RectangleStackIcon, current: false },
