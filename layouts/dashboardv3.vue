<template>
    <div>
        <div
            v-if="drawerStore.isAuthDrawerOpen"
        ...
        >
            ...
            <div class="fixed inset-0 flex">
                <div class="relative mr-16 flex w-full max-w-10/12 flex-1">
                    <div
                    ...
                    >
                        <button
                            type="button"
                            class="-m-2.5 p-2.5"
                            @click="drawerStore.toggleAuthDrawer"
                        >
                    ...
                    <div
                        class="flex grow flex-col gap-y-5 overflow-y-auto bg-white pb-4"
                    >
                        <nav class="flex flex-1 flex-col">
                            <div
                                class="relative flex h-full flex-col border-r border-gray-200 bg-gray-100"
                            >
                                <div class="flex-shrink-0">
                                    <div
                                        class="flex h-[108px] flex-col justify-center bg-white px-6"
                                    >
        ...
        <div
            class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-96 lg:flex-col"
        >
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white">
                ...
                <nav class="flex flex-1 flex-col">
                    ...
                    >
                        <div class="flex-shrink-0">
                            <div
                                class="flex h-[62px] flex-col justify-center bg-white px-6"
                            >
                                <div class="flex space-x-3">
                                    <div class="w-full">
                                        <h2
